...
export default function RecipeForm() {
  ...
  return (
    ...
    <h2 className="mx-9 "> Nous avons hâte de déguster ça !!!</h2>
              ...
              <header>
                ...
                <div className='set'>
                  <div className='recipe-name'>
                    <label htmlFor='recipe-name'><h6> Recette</h6></label>
                    <input
                      type="text"
                      id="name"
                      name="name"
              ...
              <footer>
                <div className='set'>
                    ...
                    id='send'> 
                    <h3>
                      SOUMETTRE AUX PAPILLES  <span className="text-yellow-500"> !!!</span>
                    </h3>   
                      </button>
                </div>
              </footer>
            ...
            <div className='right-container'>
              ...
              <div className='img-container'>
                <img src="https://spoonacular.com/recipeImages/6405-556x370.jpg" alt="image de plat" />
              </div>
            </div>
          </div>
